...
async def add_to_queue(body: WaitingQueueBody) -> Dict[str, Any]:
...
async def get_notifications(student_id: str) -> List[Dict]:
...
async def accept(notification_id: str) -> Dict[str, Any]:
