...
// Preferences
router.get('/me/preferences', studentController.getPreferences);

router.put('/me/preferences', validate(updatePreferencesSchema), studentController.updatePreferences);

// Account deletion
router.delete('/me', studentController.deleteAccount);
