...
const register = async (req, res, next) => {
  try {
    ...
    // Note: student_id is auto-generated, but we check if provided for validation
    if (student_id) {
      ...
      // If a valid student_id is provided, it will be used (internal/admin use)
      // Otherwise, it will be auto-generated by the model
    }
